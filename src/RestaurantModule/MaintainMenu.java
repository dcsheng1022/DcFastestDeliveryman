...
public class MaintainMenu extends javax.swing.JFrame {
    ...
    private void Display_FoodTable() {
        try {
            String sql = "SELECT food_id as ID,food_name as Name,CAST(food_price as Decimal(18,2)) as Price_RM  FROM MENU Where food_category = 'Food'";
    ...
    private void Display_BeverageTable() {
        try {
            String sql = "SELECT food_id as ID,food_name as Name,CAST(food_price as Decimal(18,2)) as Price_RM FROM MENU Where food_category = 'Beverages'";
            stmt = conn.prepareStatement(sql);
            rs = stmt.executeQuery();
